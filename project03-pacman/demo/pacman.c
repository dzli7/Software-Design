...
const double INITIAL_PACMAN_MASS = 0;
...
body_t *make_circle() {
    ...
    return body_init(c, CIRCLE_MASS, choose_rand_color(), ROTATION);
}
...
body_t *make_pacman() {
    ...
    *SPAWN = PACMAN_SPAWN;
    ...
    return body_init(shape, INITIAL_PACMAN_MASS, PACMAN_COLOR, ROTATION);
}
